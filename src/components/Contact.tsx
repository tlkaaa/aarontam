...
export default function Contact() {
    return (
        <article className="contact">
            <h4 className="contact-title" id="contact">
                Get In Touch
            </h4>
            ...
            <div className="contact-details">
                <div>
                    <img src="email.PNG" width={27} alt="Email" />{" "}
                    <p>aarontam9529@gmail.com</p>
                </div>
                <div>
                    <img src="linkedin.PNG" width={27} alt="Linkedin" />
                    <p>
                        <a
                ...
                <div>
                    <img src="github.PNG" width={27} alt="GitHub" />
                    <p>
